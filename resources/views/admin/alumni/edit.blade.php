...
@section('content')
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('alumni.update', $alumni->idAlumni)}}"method="POST">
                @csrf
                @method('PUT')
                <div class="container">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{$alumni->nama_alumni}}" class="form-control" id="nama_alumni" name="nama_alumni">
                            @error('nama_alumni')
